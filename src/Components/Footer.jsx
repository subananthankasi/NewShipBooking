      ...
      >
        <div className="footer-top">
          ...
          <div className="container">
            <div className="cta-style1" style={{backgroundColor:"#ff681a",position:"relative",top:"-100px"}}>
              <div className="row g-5 align-items-center justify-content-between">
                <div className="col-lg-6">
                  <div className="cta-content">
                    ...
                    <a href="sign-up.html" className="vs-btn style2">
                      Open An Account
                    </a>
                  </div>
                </div>
                <div className="col-md-5 col-sm-6">
                  <div className="cta-image d-lg-block d-none">
                    <img src={newsLetter} alt="CTA Image" style={{width:"300px",height:"250px"}}/>
                  </div>
                </div>
              </div>
            </div>
